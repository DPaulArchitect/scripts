...
class FA_MarkAnswered extends TriggerAction {
    static $type = 'isanswered';
    ...
    function apply(&$ticket, array $info) {
     ...
     /**
     * Returns the configuration options for this filter action.
     *
    ...
    function getConfigurationOptions() {
        return array(
            '' => new FreeTextField(array(
                'configuration' => array(
                    'content' => __('<strong>Mark Ticket</strong> Answered / Read')
                ),
            )),
        );
    }
...
FilterAction::register('FA_MarkAnswered', /* @trans */ 'Ticket');
